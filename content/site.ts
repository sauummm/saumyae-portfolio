 ...
 *
 * NOTE on `url`: placeholder until the real Vercel deployment URL (or a
 * custom domain) is confirmed — used for `metadataBase` in app/layout.tsx.
 * Update this the moment the live URL is known; OG images and canonical
 * links are wrong until it matches reality.
 */
export const site: SiteConfig = {
  ...
  phone: '+91-9599588492',
  url: 'https://saumyaejoshi.vercel.app',
  social: [
